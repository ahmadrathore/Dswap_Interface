    ...
    <>
      <PageWrapper gap="lg" justify="center">
              ...
              <AutoColumn gap="md">
                <RowBetween>
                  <TYPE.white fontWeight={600}>
                    <Trans>Delioswap Governance</Trans>
                  </TYPE.white>
                </RowBetween>
                <RowBetween>
                  <TYPE.white fontSize={14}>
                    <Trans>
                      DSP tokens represent voting shares in Delioswap governance. You can vote on each proposal yourself
                ...
                <ExternalLink
                  ...
                  href="https://infonet.gist.ac.kr/?p=9142"
                  target="_blank"
                >
                  <TYPE.white fontSize={14}>
                    <Trans>Read more about Delioswap governance</Trans>
                  </TYPE.white>
                </ExternalLink>
              </AutoColumn>
            </CardSection>
        ...
        <TYPE.subHeader color="text3">
          <Trans>A minimum threshold of 0.25% of the total DSP supply is required to submit proposals</Trans>
        </TYPE.subHeader>
      </PageWrapper>
      <SwitchLocaleLink />
    </>
